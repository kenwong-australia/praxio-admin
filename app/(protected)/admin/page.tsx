            ...
            <div className="flex gap-2">
              ...
              <DocxDownloadButton
                ...
                data={{
                  ...
                  kpis: kpis ? [
                    { title: 'Total Scenarios', value: kpis.totalScenarios },
                    { title: 'Total Processing Time (s)', value: kpis.totalProcessingTime },
                    { title: 'Avg Processing Time (s)', value: kpis.avgProcessingTime },
                    { title: 'Engagement Rate', value: kpis.engagementRate },
                    { title: 'Total Feedback', value: kpis.totalFeedback },
                    { title: 'Avg Feedback Score', value: kpis.avgFeedbackScore },
                  ] : [],
